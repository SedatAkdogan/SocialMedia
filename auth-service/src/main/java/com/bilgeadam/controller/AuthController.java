 ...
 */
    ...
    /**
     * Gonderilen value aynı ise metodun içine girilmez onbellekten gonderir.
     * @param value
     * @return
     */
    @GetMapping("/redis")
    ...
    public Boolean redisDelete2(){
        try {
 //           cacheManager.getCache("redisexample").clear(); // redisexample etiketkli butun cache'leri temizler
