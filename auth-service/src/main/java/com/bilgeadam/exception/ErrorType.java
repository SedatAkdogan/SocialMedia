...
public enum ErrorType {
    ...
    USER_NOT_CREATED(4116,"Kullanici profili olusturulamadi...",HttpStatus.BAD_REQUEST),
    ACCOUNT_NOT_ACTIVE(4117,"Hesabınız aktif edilmemiştir. Lütfen hesabınızı aktif hale getiriniz..." , HttpStatus.FORBIDDEN),
    ROLE_NOT_FOUND(4118,"bOYLE BİR KULLANİCİ ROLU BULUNMAMAKTADİR",HttpStatus.BAD_REQUEST);
    private int code;
